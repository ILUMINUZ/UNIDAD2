...
void llenado(LIBRO *p, int cant) {
	string titulos[] = {"Bulling", "Bulling 2", "Trading en la zona", "Padre rico, padre pobre", "9 Habitos atomicos", "Tulipanes en diciembre", "Patito feo", "La verdad del dinero"};
	...
	do {
		...
		case 2:
			do {
				...
				case 'a': // Agregar este caso para aceptar 'a' en minúscula
					LimpiarPantalla();
					cout << "Listado de Libros:" << endl;
					ImprimirListaCompleta(arrLibros, TAM_LIBROS);
					break;
				...
				case 'b': // Agregar este caso para aceptar 'b' en minúscula
					LimpiarPantalla();
					cout << "Listado de Usuarios:" << endl;
					ImprimirListaCompleta(arrUsuarios, TAM_USUARIOS);
					break;
				...
				case 'c': // Agregar este caso para aceptar 'c' en minúscula
					LimpiarPantalla();
					cout << "Listado de Bibliotecarios:" << endl;
					ImprimirListaCompleta(arrBibliotecarios, TAM_BIBLIOTECARIOS);
					break;
				...
				case 'x': // Agregar este caso para aceptar 'x' en minúscula
					cout << "Volviendo al Menú Principal." << endl;
					break;
